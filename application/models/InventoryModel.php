...
class InventoryModel extends CI_Model {
    ...
    public function get_return_log()
    {
        ...
        $this->db->Select ('account_code,department,return_person,item_status,supplier,serial,item_name,date,unit_cost,concat(user.first_name," ",user.last_name) as user,reason,inventory.item.quantity');
